...
# Вибрати всіх користувачів з їхніми транзакціями
cursor.execute('''
...
# Знайти суму всіх транзакцій користувача з вказаною електронною поштою
...
# Знайти найбільшу транзакцію в заданій категорії
category_name = "Їжа"
cursor.execute('''
